...
//using CalculoFinanciero = modelo_finanzas.Services.AmortizacionService;
namespace modelo_finanzas
{
    public partial class FormEntradaDatos : Form
    {
       ...
       // CalculoFinanciero miCalculadora = new CalculoFinanciero();
        // modelo_finanzas.Services.AmortizacionService miCalculadora = new modelo_finanzas.Services.AmortizacionService();
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Aquí convertimos los datos para que la calculadora los acepte

                var servicioAmort = new global::modelo_finanzas.Services.AmortizacionService();

                var listaCalculada = servicioAmort.CalcularTabla(
                    (double)datos.InversionEquipos,
                    0.15, // Tasa del 15%
                    (int)datos.PlazoCredito
                );
                // 2. Si tienes un DataGridView (tabla) en pantalla, le pasas los datos así:
                // nombreDeTuTabla.DataSource = listaResultados;
